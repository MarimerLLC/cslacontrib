...
Namespace CslaSrd
    ...
    ''' </remarks>
    <Serializable()> _
    Public Structure SmartInt16
        Implements IComparable
        Private _int As Int16
...
#Region "Constructors"
        ...
        ''' <param name="value">The initial value of the object.</param>
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        Public Sub New(ByVal value As Int16, ByVal emptyIsMin As Boolean)
            _emptyIsMax = Not emptyIsMin
            _format = Nothing
            _initialized = False
            _int = Int16.MinValue
...
#Region "System.Object overrides"
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            If TypeOf obj Is SmartInt16 Then
                Dim tmp As SmartInt16 = CType(obj, SmartInt16)
            ...
            ElseIf TypeOf obj Is Int16 Then
                Return Me.Int.Equals(CShort(Fix(obj)))
...
#Region "Empty Ints"
        ...
        Public ReadOnly Property IsEmpty() As Boolean
            Get
                If (Not _emptyIsMax) Then
                    Return Me.Int.Equals(Int16.MinValue)
                Else
                    Return Me.Int.Equals(Int16.MaxValue)
                End If
            End Get
        End Property
...
#Region "Conversion Functions"
        ...
        ''' </remarks>
        Public Shared Function Parse(ByVal value As String) As SmartInt16
        ...
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        ''' <returns>A new SmartInt16 containing the int value.</returns>
        Public Shared Function Parse(ByVal value As String, ByVal emptyIsMin As Boolean) As SmartInt16
        ...
        Public Shared Function StringToInt(ByVal value As String) As Int16
        ...
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        ''' <returns>A Int value.</returns>
        Public Shared Function StringToInt(ByVal value As String, ByVal emptyIsMin As Boolean) As Int16
            Dim tmp As Int16
            If String.IsNullOrEmpty(value) Then
                ...
                End If
            ElseIf Int16.TryParse(value, tmp) Then
                Return tmp
            Else
                Dim lint As String = value.Trim().ToLower()
                Throw New ArgumentException(My.Resources.StringToInt16Exception)
            End If
        End Function
        ...
        Public Shared Function IntToString(ByVal value As Int16, ByVal formatString As String) As String
        ...
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        ''' <returns>Text representation of the int value.</returns>
        Public Shared Function IntToString(ByVal value As Int16, ByVal formatString As String, ByVal emptyIsMin As Boolean) As String
            If emptyIsMin AndAlso value = Int16.MinValue Then
                Return String.Empty
            ElseIf (Not emptyIsMin) AndAlso value = Int16.MaxValue Then
                Return String.Empty
            Else
...
#Region "Manipulation Functions"
        ...
        Public Function CompareTo(ByVal value As SmartInt16) As Integer
        ...
        Private Function CompareTo(ByVal value As Object) As Integer Implements IComparable.CompareTo
            If TypeOf value Is SmartInt16 Then
                Return CompareTo(CType(value, SmartInt16))
            Else
                Throw New ArgumentException(My.Resources.ValueNotSmartInt16Exception)
            End If
        End Function
        ...
        ''' <param name="value">The int to which we are being compared.</param>
        ''' <returns>A value indicating if the comparison int is less than, equal to or greater than this int.</returns>
        Public Function CompareTo(ByVal value As Int16) As Integer
        ...
        ''' </summary>
        Public Function Add(ByVal value As Int16) As Int16
            If IsEmpty Then
                Return Me.Int
            Else
                Return CShort(Fix(Me.Int + value))
            End If
        End Function
        ...
        ''' </summary>
        Public Function Subtract(ByVal value As Int16) As Int16
            If IsEmpty Then
                Return Me.Int
            Else
                Return CShort(Fix(Me.Int - value))
...
#Region "Operators"
        ...
        Public Shared Operator =(ByVal obj1 As SmartInt16, ByVal obj2 As SmartInt16) As Boolean
        ...
        Public Shared Operator =(ByVal obj1 As SmartInt16, ByVal obj2 As Int16) As Boolean
            Return obj1.Equals(obj2)
        End Operator
        ''' <summary>
        ...
        ''' <param name="obj2">The Int16 to compare</param>
        ''' <returns>Whether the two values are equal</returns>
        Public Shared Operator =(ByVal obj1 As SmartInt16, ByVal obj2 As String) As Boolean
            Return obj1.Equals(obj2)
        End Operator
        ''' <summary>
        ...
        Public Shared Operator +(ByVal start As SmartInt16, ByVal span As Int16) As SmartInt16
        ...
        ''' <returns>The calculated result</returns>
        Public Shared Operator -(ByVal start As SmartInt16, ByVal finish As SmartInt16) As Int16
