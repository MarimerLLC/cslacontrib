...
namespace MyCsla.Windows
{
    ...
    /// <example>
    /// 1) Add a ToolStip to the form and add 2 ToolStripStatusLabels.
    /// 2) Add the StatusStripExtender to the form.
    /// 3) Connect statusStripExtender1.StatusControl to toolStripStatusLabel1
    ///    and statusStripExtender1.AnimationControl to toolStripStatusLabel2
    /// 4) Set status text with statusStripExtender1.SetStatus
    ///    and view animation with statusStripExtender1.AnimationVisible
    /// </example> 
    /// </summary>    
    [ProvideProperty("StatusStripManager", typeof(Control))]
    public class StatusStripManager : Component
    {
      ...
      /// Stops the progress indicator from running
        ...
        {
          UpdateStatusStrip(text, false, false, _statusDefaultDuration);
        }
