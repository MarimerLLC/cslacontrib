...
{
	/// <summary>
	///	CustomerOrder Generated by MyGeneration using the CSLA Object Mapping template
	/// </summary>
	[Serializable()]
	[TypeConverter(typeof(CustomerOrderConverter))]
	public partial class CustomerOrder : BusinessBase<CustomerOrder>, IVEHasBrokenRules
	{
		...
		// TODO: Check CustomerOrder.GetIdValue to assure that the ID returned is unique
		/// <summary>
		/// Overrides Base GetIdValue - Used internally by CSLA to determine equality
		/// </summary>
		/// <returns>A Unique ID for the current CustomerOrder</returns>
		protected override object GetIdValue()
		{
			return _OrderID;
		}
		// TODO: Replace base CustomerOrder.ToString function as necessary
		/// <summary>
		/// Overrides Base ToString
		/// </summary>
		/// <returns>A string representation of current CustomerOrder</returns>
		...
		{
			ValidationRules.AddRule<CustomerOrder>(OrderDateValid, "OrderDate");
			ValidationRules.AddRule<CustomerOrder>(RequiredDateValid, "RequiredDate");
			ValidationRules.AddRule<CustomerOrder>(ShippedDateValid, "ShippedDate");
		...
		private static bool OrderDateValid(CustomerOrder target, Csla.Validation.RuleArgs e)
		{
			try
			{
		...
		private static bool RequiredDateValid(CustomerOrder target, Csla.Validation.RuleArgs e)
		{
			try
			{
		...
		private static bool ShippedDateValid(CustomerOrder target, Csla.Validation.RuleArgs e)
		{
			try
			{
		...
		internal static CustomerOrder New()
		{
			return new CustomerOrder();
		}
		internal static CustomerOrder Get(SafeDataReader dr)
		{
		...
		public CustomerOrder()
		{
			...
			_Freight = _CustomerOrderExtension.DefaultFreight;
			ValidationRules.CheckRules();
		}
		internal CustomerOrder(SafeDataReader dr)
		{
			MarkAsChild();
			Fetch(dr);
		}
		...
		{
			Database.LogInfo("CustomerOrder.FetchDR", GetHashCode());
			try
			{
			...
			{
				Database.LogException("CustomerOrder.FetchDR", ex);
				throw new DbCslaException("CustomerOrder.Fetch", ex);
			}
			MarkOld();
		}
		internal void Insert(Customer myCustomer)
		{
			...
			Order.Add(cn, ref _OrderID, myCustomer, _MyEmployee, new SmartDate(_OrderDate), new SmartDate(_RequiredDate), new SmartDate(_ShippedDate), _MyShipper, _Freight, _ShipName, _ShipAddress, _ShipCity, _ShipRegion, _ShipPostalCode, _ShipCountry);
			MarkOld();
		}
		internal void Update(Customer myCustomer)
		{
			...
			if (!this.IsDirty) return;
			SqlConnection cn = (SqlConnection)ApplicationContext.LocalContext["cn"];
			Order.Update(cn, ref _OrderID, myCustomer, _MyEmployee, new SmartDate(_OrderDate), new SmartDate(_RequiredDate), new SmartDate(_ShippedDate), _MyShipper, _Freight, _ShipName, _ShipAddress, _ShipCity, _ShipRegion, _ShipPostalCode, _ShipCountry);
			MarkOld();
		}
		...
		#region extension
		CustomerOrderExtension _CustomerOrderExtension = new CustomerOrderExtension();
		[Serializable()]
		partial class CustomerOrderExtension : extensionBase
		{
		}
		[Serializable()]
		class extensionBase
	...
	#region Converter
	internal class CustomerOrderConverter : ExpandableObjectConverter
	{
		public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destType)
		{
			if (destType == typeof(string) && value is CustomerOrder)
			{
				// Return the ToString value
				return ((CustomerOrder)value).ToString();
			}
...
//// The following is a sample Extension File.  You can use it to create CustomerOrderExt.cs
//using System;
