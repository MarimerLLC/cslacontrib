...
Namespace CslaSrd
    ...
    ''' </remarks>
    <Serializable()> _
    Public Structure SmartInt64
        Implements IComparable
        Private _int As Int64
...
#Region "Constructors"
        ...
        ''' <param name="value">The initial value of the object.</param>
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        Public Sub New(ByVal value As Int64, ByVal emptyIsMin As Boolean)
            _emptyIsMax = Not emptyIsMin
            _format = Nothing
            _initialized = False
            _int = Int64.MinValue
...
#Region "System.Object overrides"
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            If TypeOf obj Is SmartInt64 Then
                Dim tmp As SmartInt64 = CType(obj, SmartInt64)
            ...
            ElseIf TypeOf obj Is Int64 Then
                Return Me.Int.Equals(CLng(Fix(obj)))
...
#Region "Empty Ints"
        ...
        Public ReadOnly Property IsEmpty() As Boolean
            Get
                If (Not _emptyIsMax) Then
                    Return Me.Int.Equals(Int64.MinValue)
                Else
                    Return Me.Int.Equals(Int64.MaxValue)
                End If
            End Get
        End Property
...
#Region "Conversion Functions"
        ...
        ''' </remarks>
        Public Shared Function Parse(ByVal value As String) As SmartInt64
        ...
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        ''' <returns>A new SmartInt64 containing the int value.</returns>
        Public Shared Function Parse(ByVal value As String, ByVal emptyIsMin As Boolean) As SmartInt64
        ...
        Public Shared Function StringToInt(ByVal value As String) As Int64
        ...
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        ''' <returns>A Int value.</returns>
        Public Shared Function StringToInt(ByVal value As String, ByVal emptyIsMin As Boolean) As Int64
            Dim tmp As Int64
            If String.IsNullOrEmpty(value) Then
                ...
                End If
            ElseIf Int64.TryParse(value, tmp) Then
                Return tmp
            Else
                Dim lint As String = value.Trim().ToLower()
                Throw New ArgumentException(My.Resources.StringToInt64Exception)
            End If
        End Function
        ...
        Public Shared Function IntToString(ByVal value As Int64, ByVal formatString As String) As String
        ...
        ''' <param name="emptyIsMin">Indicates whether an empty int is the min or max int value.</param>
        ''' <returns>Text representation of the int value.</returns>
        Public Shared Function IntToString(ByVal value As Int64, ByVal formatString As String, ByVal emptyIsMin As Boolean) As String
            If emptyIsMin AndAlso value = Int64.MinValue Then
                Return String.Empty
            ElseIf (Not emptyIsMin) AndAlso value = Int64.MaxValue Then
                Return String.Empty
            Else
...
#Region "Manipulation Functions"
        ...
        Public Function CompareTo(ByVal value As SmartInt64) As Integer
        ...
        Private Function CompareTo(ByVal value As Object) As Integer Implements IComparable.CompareTo
            If TypeOf value Is SmartInt64 Then
                Return CompareTo(CType(value, SmartInt64))
            Else
                Throw New ArgumentException(My.Resources.ValueNotSmartInt64Exception)
            End If
        End Function
        ...
        ''' <param name="value">The int to which we are being compared.</param>
        ''' <returns>A value indicating if the comparison int is less than, equal to or greater than this int.</returns>
        Public Function CompareTo(ByVal value As Int64) As Integer
        ...
        ''' </summary>
        Public Function Add(ByVal value As Int64) As Int64
            If IsEmpty Then
                Return Me.Int
            Else
                Return CLng(Fix(Me.Int + value))
            End If
        End Function
        ...
        ''' </summary>
        Public Function Subtract(ByVal value As Int64) As Int64
            If IsEmpty Then
                Return Me.Int
            Else
                Return CLng(Fix(Me.Int - value))
...
#Region "Operators"
        ...
        Public Shared Operator =(ByVal obj1 As SmartInt64, ByVal obj2 As SmartInt64) As Boolean
        ...
        Public Shared Operator =(ByVal obj1 As SmartInt64, ByVal obj2 As Int64) As Boolean
            Return obj1.Equals(obj2)
        End Operator
        ''' <summary>
        ...
        ''' <param name="obj2">The Int64 to compare</param>
        ''' <returns>Whether the two values are equal</returns>
        Public Shared Operator =(ByVal obj1 As SmartInt64, ByVal obj2 As String) As Boolean
            Return obj1.Equals(obj2)
        End Operator
        ''' <summary>
        ...
        Public Shared Operator +(ByVal start As SmartInt64, ByVal span As Int64) As SmartInt64
        ...
        ''' <returns>The calculated result</returns>
        Public Shared Operator -(ByVal start As SmartInt64, ByVal finish As SmartInt64) As Int64
