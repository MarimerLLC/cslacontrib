...
namespace OutlookStyle.Infrastructure.ModelVisualization
{
    ...
    /// 
    /// This behavior will wrap the normal region with a VisualizingRegion and add THAT to the regionmanager, in stead of the 
    /// normal regionmanager. It will also attach the AutoPopulateBehavior to the original region. 
    /// </summary>
    public class VisualizingRegionManagerRegistrationBehavior : RegionBehavior, IHostAwareRegionBehavior
    {
        private readonly VisualizingRegion visualizingRegion;
        private readonly AutoPopulateRegionBehavior autoPopulateRegionBehavior;
        ...
        public DependencyObject HostControl
        {
            ...
            set
            {
                if (IsAttached)
                {
                    throw new InvalidOperationException("Cannot set host control after attach");
                }
