...
using Outlook.Modules.Email;
using Outlook.Modules.Exchange;
...
namespace OutlookStyleApp
{
    ...
    public class Bootstrapper : UnityBootstrapper
    {
        ...
        protected override IModuleCatalog GetModuleCatalog()
        {
            ...
            catalog.AddModule(typeof(EmailModule), "ExchangeModule");
            catalog.AddModule(typeof(CalendarModule), "ExchangeModule");
            catalog.AddModule(typeof(ExchangeModule));
            return catalog;
        }
    }
}
