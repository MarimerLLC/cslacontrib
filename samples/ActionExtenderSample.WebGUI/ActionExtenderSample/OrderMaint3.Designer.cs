...
namespace ActionExtenderSample
{
  partial class OrderMaint3
  {
    ...
    private void InitializeComponent()
    {
      ...
      // toolSave
      // 
      this.toolSave.DisplayStyle = Gizmox.WebGUI.Forms.ToolStripItemDisplayStyle.Text;
      ...
      // toolCancel
      // 
      this.toolCancel.DisplayStyle = Gizmox.WebGUI.Forms.ToolStripItemDisplayStyle.Text;
      ...
      // toolClose
      // 
      this.toolClose.DisplayStyle = Gizmox.WebGUI.Forms.ToolStripItemDisplayStyle.Text;
