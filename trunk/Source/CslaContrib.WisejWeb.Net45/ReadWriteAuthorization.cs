...
namespace CslaContrib.WisejWeb
{
  ...
  [ToolboxItem(true), ToolboxBitmap(typeof(ReadWriteAuthorization), "ReadWriteAuthorization")]
  public class ReadWriteAuthorization : Wisej.Web.Component, IExtenderProvider
  {
